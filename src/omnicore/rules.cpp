...
std::vector<TransactionRestriction> CConsensusParams::GetRestrictions() const
{
    ...
    { //  transaction type                    version        allow 0  activation block
      //  ----------------------------------  -------------  -------  ------------------
		...
		{ MSC_TYPE_SEND_AGREEMENT,            MP_TX_PKT_V0,  false,   MSC_SEND_AGREEMENT },
...
CMainConsensusParams::CMainConsensusParams()
{
    ...
    MSC_ALERT_BLOCK = 0;
    MSC_SEND_BLOCK = 46000;
    MSC_DEX_BLOCK = 46000;
    MSC_SP_BLOCK = 46000;
    MSC_MANUALSP_BLOCK = 46000;
    MSC_STO_BLOCK = 46000;
    MSC_METADEX_BLOCK = 46000;
    MSC_SEND_ALL_BLOCK = 46000;
